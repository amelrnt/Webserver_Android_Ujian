<div id="tambah_web" class="col-md-3 collapse">
  <!--div class=""-->
    <div class="modal-content">
    	<div class="modal-header modal-primary">
			<h3 class="panel-title text-center"><strong>Tambah Soal Pemrograman Berbasis Web</strong></h3>
  		</div>
  		<div class="modal-body">
 		<form action="<?=base_url()?>index.php/cujian/input/web" method="POST" enctype="multipart/form-data">
