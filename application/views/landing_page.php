  ...
  <div id="topbar" class="clear"> 
    ...
    <nav>
      <ul>
        ...
        <li><a href="<?=base_url()?>cujian/login">Staff Login</a></li>
      </ul>
    </nav>
    <!-- ################################################################################################ --> 
  </div>
...
<div class="wrapper">
  <div id="slider">
    <div id="slide-wrapper" class="rounded clear"> 
      <!-- ################################################################################################ -->
      <figure id="slide-1"><a class="view" href="#"><img src="<?=base_url()?>images/demo/slider/1.png" alt=""></a>
        <figcaption>
      ...
      <figure id="slide-2"><a class="view" href="#"><img src="<?=base_url()?>images/demo/slider/2.png" alt=""></a>
        <figcaption>
      ...
      <figure id="slide-3"><a class="view" href="#"><img src="<?=base_url()?>images/demo/slider/3.png" alt=""></a>
        <figcaption>
          <h2>Aliquatjusto quisque nam</h2>
          <p>Attincidunt vel nam a maurisus lacinia consectetus magnisl sed ac morbi. Inmaurisus habitur pretium eu et ac vest penatibus id lacus parturpis.</p>
          <p class="right"><a href="#">Continue Reading &raquo;</a></p>
      ...
      <figure id="slide-4"><a class="view" href="#"><img src="<?=base_url()?>images/demo/slider/4.png" alt=""></a>
        <figcaption>
          <h2>Aliquatjusto quisque nam</h2>
          <p>Attincidunt vel nam a maurisus lacinia consectetus magnisl sed ac morbi. Inmaurisus habitur pretium eu et ac vest penatibus id lacus parturpis.</p>
          <p class="right"><a href="#">Continue Reading &raquo;</a></p>
      ...
      <figure id="slide-5"><a class="view" href="#"><img src="<?=base_url()?>images/demo/slider/5.png" alt=""></a>
        <figcaption>
      ...
      <div class="group btmspace-30"> 
        ...
        <div class="one_quarter first"> 
          ...
          <ul class="nospace">
            ...
            <li><a href="#"><em class="heading">Alumni</em> <img class="borderedbox" src="<?=base_url()?>images/demo/220x95.gif" alt=""></a></li>
          </ul>
          <!-- ################################################################################################ --> 
        </div>
        <!-- / Left Column --> 
        ...
        <div class="one_half"> 
          ...
          <ul class="nospace listing">
            <li class="clear">
              <div class="imgl borderedbox"><img src="<?=base_url()?>images/demo/120x120.gif" alt=""></div>
        ...
        <div class="one_quarter sidebar"> 
          ...
          <div class="sdb_holder">
            <h6>Virtual Tour</h6>
            <div class="mediacontainer"><img src="<?=base_url()?>images/demo/video.gif" alt="">
          ...
          <div class="sdb_holder">
            ...
            <ul class="nospace quickinfo">
              <li class="clear"><a href="#"><img src="<?=base_url()?>images/demo/80x80.gif" alt=""> Make An Application</a></li>
              <li class="clear"><a href="#"><img src="<?=base_url()?>images/demo/80x80.gif" alt=""> Order A Prospectus</a></li>
            </ul>
          </div>
          <!-- ################################################################################################ --> 
        </div>
  ...
  <div class="rounded">
    <footer id="footer" class="clear"> 
      ...
      <div class="one_third first">
        <figure class="center"><img class="btmspace-15" src="<?=base_url()?>images/demo/worldmap.png" alt="">
...
<script src="scripts/tabslet/jquery.tabslet.min.js"></script>
</body>
</html>