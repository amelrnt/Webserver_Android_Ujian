...
<div class="col-md-3">
  <div class="modal-content">
      ...
      <h3 class="panel-title text-center"><strong>Edit Soal Pemrograman Jaringan</strong></h3>
      </div>
  	<div class="modal-body">
 		<form action="<?=base_url()?>index.php/cujian/editsoal/3/<?=$id?>" method="POST">
      ...
      <?php foreach($edit as $row){?>
			<div class="form-group">
    			...
    			<input type="text" class="form-control" id="pertanyaan" name="pertanyaan" value="<?=$row['soal']?>">
			</div>
			<div class="form-group">
