...
--
-- Host: localhost
-- Generation Time: Aug 25, 2021 at 02:32 PM
...
--
-- Table structure for table `tbl_final_exam`
--

CREATE TABLE `tbl_final_exam` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `tbl_final_exam`
--

INSERT INTO `tbl_final_exam` (`id`, `nama`, `waktu_mulai`, `waktu_selesai`) VALUES
(1, 'abc', '2021-08-09 11:00:00', '2021-08-09 11:26:21'),
(2, 'uts', '2021-08-25 12:03:04', '2021-08-25 13:03:04');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_nilai_exam`
--

CREATE TABLE `tbl_nilai_exam` (
  `id` int(11) NOT NULL,
  `nama` varchar(255) NOT NULL,
...
--
-- Dumping data for table `tbl_nilai_exam`
--

INSERT INTO `tbl_nilai_exam` (`id`, `nama`, `nilai`, `id_final_exam`) VALUES
(1, 'hatta', 95, 1),
(2, 'amel', 98, 2),
(3, 'amel b', 85, 1);
...
--
-- Table structure for table `tbl_soal_exam`
--

CREATE TABLE `tbl_soal_exam` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `tbl_soal_exam`
--

INSERT INTO `tbl_soal_exam` (`id`, `id_soal`, `id_final_exam`) VALUES
(1, 1, 1);
...
--
-- Indexes for table `tbl_final_exam`
--
ALTER TABLE `tbl_final_exam`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_nilai_exam`
--
ALTER TABLE `tbl_nilai_exam`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tbl_soal_exam`
--
ALTER TABLE `tbl_soal_exam`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_final_exam`
--
ALTER TABLE `tbl_final_exam`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbl_nilai_exam`
--
ALTER TABLE `tbl_nilai_exam`
...
--
-- AUTO_INCREMENT for table `tbl_soal_exam`
--
ALTER TABLE `tbl_soal_exam`
